-- ==========================================
-- TPC-DS v3.2.0 — 24-table DDL
-- Target schema: raw
-- No PK/FK constraints — raw layer is append-only, constraints go in staging/marts
-- ==========================================
...
CREATE TABLE raw.customer_demographics (
    cd_demo_sk                INTEGER,
    cd_gender                 CHAR(1),
...
CREATE TABLE raw.customer_address (
...
CREATE TABLE raw.household_demographics (
    hd_demo_sk                INTEGER,
...
CREATE TABLE raw.reason (
    r_reason_sk               INTEGER,
    r_reason_id               CHAR(16),
    r_reason_desc             CHAR(100)
);

CREATE TABLE raw.income_band (
    ib_income_band_sk         INTEGER,
    ib_lower_bound            INTEGER,
    ib_upper_bound            INTEGER
);

CREATE TABLE raw.call_center (
...
CREATE TABLE raw.store_returns (
...
CREATE TABLE raw.catalog_sales (
...
CREATE TABLE raw.catalog_returns (
